...
![alt text](addProducts.png)


![alt text](erros-produtos.png)

O botão só libera se todos os inputs forem preenchidos corretamente de acordo com o regex

![alt text](validatingProduct.png)

![alt text](successAdding.png)

![alt text](showingAdded.png)
...
![alt text](setting-dataId.png)

![alt text](dataid-example.png)
...
![alt text](edit-products.png)


![alt text](editing-product.png)


![alt text](edit-response.png)


![alt text](edit-success.png)
...
![alt text](user-dropdown.png)


![alt text](user-data.png)


![alt text](user-config.png)


![alt text](user-editing.png)


![alt text](newNickname.png)


Possibilitei o usuário de voltar ao seu nome original também:


![alt text](undo_name.png)


O front retorna um alert informando que a edição foi bem-sucedida:


![alt text](useredit-success.png)
...
![alt text](changePassJS.png)

Backend recebe e atualiza:

![alt text](backend-changepass.png)
...
![alt text](reqParams.png)


Lógica do params:

![alt text](params-code.png)
...
![alt text](backend-Editing.png)

Rota:

![alt text](editRoute.png)
